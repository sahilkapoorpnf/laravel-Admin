...
<div class="content-header">
    <div class="header-section">
        <h1>
            <i class="fa fa-table"></i>Specialities<br><small>You can add new category from here to submit this form!</small>
        </h1>
    </div>
</div>
<ul class="breadcrumb breadcrumb-top">
    <li>Users</li>
    <li><a href="{{url('admin/add-category')}}">Add Speciality</a></li>
</ul>
...
<div class="col-md-12">
    ...
    <div class="block">
        ...
        <div class="block-title">
            <h2><strong>Add</strong> Speciality</h2>
        </div>
        ...
        <form id="form-validation" action="" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered">
            ...
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <div class="input-group">
                            <input type="file" id="val_username" accept="image/x-png,image/gif,image/jpeg" value="{{old('image') }}" name="image" class="form-control">
