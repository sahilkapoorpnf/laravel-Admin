...
<div class="content-header">
    <div class="header-section">
        <h1>
            <i class="fa fa-table"></i>Terms Management<br><small>You can add new term from here to submit this form!</small>
        </h1>
    </div>
</div>
<ul class="breadcrumb breadcrumb-top">
    <li>Terms</li>
    <li><a href="{{url('admin/add-terms')}}">Add Terms</a></li>
</ul>
...
<div class="col-md-12">
    ...
    <div class="block">
        ...
        <form id="form-validation" action="" method="post" class="form-horizontal form-bordered">
            {{ csrf_field() }}
            <fieldset>
                <legend><i class="fa fa-angle-right"></i> Terms Info</legend>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <div class="input-group">
                            <textarea class="form-control" id="val_username" name="description">{{$userData->description}}</textarea>
